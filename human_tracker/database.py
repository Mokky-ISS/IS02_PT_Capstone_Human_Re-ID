...
class ImageDB(object):
    ...
    def __init__(self, db_name=main_db):
        ...
        # for datetime issue, check centurian's answer on link: https://stackoverflow.com/questions/14461851/how-to-have-an-automatic-timestamp-in-sqlite/14462319
        self.col_titles = "(img_id VARCHAR(255) UNIQUE, img BLOB, vector_tensor BLOB, create_datetime DATETIME NOT NULL DEFAULT (datetime(CURRENT_TIMESTAMP, 'localtime')), cam_id INTEGER, track_id TEXT, loc TEXT)"
        self.data = None
        self.image_name = []
